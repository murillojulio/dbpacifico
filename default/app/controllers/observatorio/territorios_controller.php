...
class TerritoriosController extends BackendController
{
    ...
    public function generar_pdf($id)
    {
        ...
        if ($obj_territorio->titulado == 'SI') {
            ...
            $pdf->Ln(7);
            $documento_constitucion = '<b>Documento constitución:</b> <a href="http://dbpacifico.creando.net/files/upload/territorio/resolucion/documento_constitucion/' . $obj_titulado_si->documento_constitucion . '">Ver documento</a>';
            ...
            if ($obj_titulado_si->solicitud_ampliacion_si_no == 'SI') {
                ...
                $pdf->Ln();
                $documento_ampliacion = '<b>Documento solicitud ampliación:</b> <a href="http://dbpacifico.creando.net/files/upload/territorio/resolucion/documento_ampliacion/' . $obj_titulado_si->solicitud_ampliacion_documento . '">Ver documento</a>';
            ...
            if ($obj_titulado_si->solicitud_saneamiento_si_no == 'SI') {
                ...
                $pdf->Ln();
                $documento_saneamiento = '<b>Documento solicitud saneamiento:</b> <a href="http://dbpacifico.creando.net/files/upload/territorio/resolucion/documento_saneamiento/' . $obj_titulado_si->solicitud_saneamiento_documento . '">Ver documento</a>';
            ...
            $pdf->Ln();
            $documento_solicitud_titulo = '<b>Documento solicitud título:</b> <a href="http://dbpacifico.creando.net/files/upload/territorio/resolucion/documento_solicitud_titulo/' . $obj_titulado_no->documento_solicitud_titulo . '">Ver documento</a>';
