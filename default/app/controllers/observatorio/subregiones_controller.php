...
class SubregionesController extends BackendController {
    ...
    public function agregar($departamento_id = NULL, $departamento_nombre = NULL) {
        ...
        if(Input::hasPost('subregion')) {
            ...
            {                       
              ...
              Poblacion::setPoblacion('create', Input::post('poblacion'),'subregion_id', $subregion_id);
              
              Fuente::setFuente('create', Input::post('fuente'), 'subregion', $subregion_id);
              
              Flash::valid('El subregion se ha registrado correctamente!');
        ...
        if($departamento_id)
        {
            $this->page_title = 'Agregar subregion al departamento '.$departamento_nombre;            
        }
        else
            { $this->page_title = 'Agregar subregion';}
    ...
    public function ver($key) { 
        ...
        $fuente = new Fuente();
        $this->fuentes = $fuente->getListadoFuente('subregion', $subregion->id);
